...
class MunicipalForm extends StatefulWidget {
  @override
  _MunicipalFormState createState() => _MunicipalFormState();
}

class _MunicipalFormState extends State<MunicipalForm> {
  ...
  Future postData() async {
    try {
      final response = await http.post(
        'http://parking.technolemon.com/index.php?r=mobile-api-municipal/registration',
        body: jsonEncode({
