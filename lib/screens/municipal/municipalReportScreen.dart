...
class MunicipalReportScreen extends StatefulWidget {
  static String routeName = "/municipalreport";
  final String transactionId;
  MunicipalReportScreen({this.transactionId});
  @override
  _MunicipalReportScreenState createState() => _MunicipalReportScreenState();
}

class _MunicipalReportScreenState extends State<MunicipalReportScreen> {
  var data;
