...
class PublicMotorSearch extends StatefulWidget {
  @override
  _PublicMotorSearchState createState() => _PublicMotorSearchState();
}

class _PublicMotorSearchState extends State<PublicMotorSearch> {
  String plateNo;
  List publicOrderId = [];
  String tokens;
  ...
  Future<String> generateControlNumber() async {
    try {
      ...
      final response = await http.post(
          'http://parking.technolemon.com/index.php?r=mobile-api-public/generate-controlnumber',
          body: jsonEncode(
              {"public_order_id": publicOrderId, "user_token": tokens}));
      var res;
  ...
  Future<String> generateOrder(id) async {
    try {
      ...
      print(tokens);
      final response = await http.post(
          'http://parking.technolemon.com/index.php?r=mobile-api-public/generate-public-order',
          body: jsonEncode({
            "customer_id": id,
          ...
          onPressed: () async {
            ...
            if (res == 'success') {
              ...
              return Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (context) => PublicReportScreen(
  ...
  Future getDetails() async {
    try {
      ...
      final response = await http.get(
        'http://parking.technolemon.com/index.php?r=mobile-api-public/public-moto-search&token=$tokens&plate_number=$plateNo',
      );
      var res;
      //final sharedP prefs=await
      print(response.statusCode);
        ...
        case 200:
          setState(() {
            ...
            if (res['message'] == 'Successfully') {
              ...
              data1 = res['motor_unpaid'];
              data2 = res['motor_unpaid_bill'];
              isNotFpund = false;
              check = [];
