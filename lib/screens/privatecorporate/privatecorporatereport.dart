...
class PrivateCorporateReportScreen extends StatefulWidget {
  static String routeName = "/privatecorporatescreen";
  final String transactionId;
  PrivateCorporateReportScreen({this.transactionId});
  @override
  _PrivateCorporateReportScreenState createState() =>
      _PrivateCorporateReportScreenState();
}

class _PrivateCorporateReportScreenState
    extends State<PrivateCorporateReportScreen> {
  var data;
  ...
  Future privatereceipt(String id) async {
    try {
      ...
      final response = await http.get(
        'http://parking.technolemon.com/index.php?r=mobile-api-municipal/receive-payment&token=$tokens&transaction_id=$id',
      );
      var res;
              ...
              pw.Padding(
                ...
                child: pw.Row(
                  children: [
                    ...
                    pw.Expanded(
                      flex: 5,
                      child: pw.Text(data['owner_name'].toString(),
                          style: pw.TextStyle(
                              fontSize: 20, font: ttf, color: PdfColors.black)),
                    ),
