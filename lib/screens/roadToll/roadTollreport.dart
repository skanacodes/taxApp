...
class RoadTollReport extends StatefulWidget {
  static String routeName = "/roadTollReport";
  final String transactionId;
  RoadTollReport({this.transactionId});
  @override
  _RoadTollReportState createState() => _RoadTollReportState();
}

class _RoadTollReportState extends State<RoadTollReport> {
  var data;
  bool isLoading = false;

  Future roadTollreceipt(String id) async {
    try {
      var tokens = await SharedPreferences.getInstance()
          .then((prefs) => prefs.getString('token'));
      print(tokens);
      final response = await http.get(
        'http://parking.technolemon.com/index.php?r=mobile-api-toll/toll-receive-payment&token=$tokens&transaction_id=$id',
      );
      var res;
  ...
  void initState() {
    ...
    roadTollreceipt(widget.transactionId);
    setState(() {
      isLoading = false;
    });
    // ignore: todo
                            ...
                            Padding(
                              ...
                              child: Row(
                                mainAxisAlignment:
                                    MainAxisAlignment.spaceBetween,
                                children: [
                                  Expanded(child: Text('Toll Name: ')),
                                  Expanded(
                                    child: Text(
                                      data['toll_name'].toString(),
                                      style: TextStyle(color: Colors.black),
                                    ),
                                  )
                                ],
                            ...
                            Padding(
                              ...
                              child: Row(
                                mainAxisAlignment:
                                    MainAxisAlignment.spaceBetween,
                                children: [
                                  Expanded(child: Text('Road Toll Fees: ')),
                                  Expanded(
                                    child: Text(
                                        data['Amount'].toString() + '  FBU',
                                        style: TextStyle(color: Colors.black)),
                                  )
                                ],
                              ),
                            ...
                            Padding(
                              ...
                              child: Row(
                                mainAxisAlignment:
                                    MainAxisAlignment.spaceBetween,
                                children: [
                                  Expanded(child: Text('Car Reg No: ')),
                                  Expanded(
                                    child: Text(
                                      data['Licence_plate_number'].toString(),
                                      style: TextStyle(color: Colors.black),
                                    ),
                                  )
                                ],
                            ...
                            Padding(
                              ...
                              child: Row(
                                mainAxisAlignment:
                                    MainAxisAlignment.spaceBetween,
                                children: [
                                  Expanded(child: Text('Received By: ')),
                                  Expanded(
                                    child: Text(
              ...
              pw.Padding(
                ...
                child: pw.Row(
                  children: [
                    ...
                    pw.Expanded(
                      flex: 5,
                      child: pw.Text('Cargo Type:',
                          style: pw.TextStyle(
                              fontSize: 20, font: ttf, color: PdfColors.black)),
                    ),
                    pw.Expanded(
                      flex: 5,
                      child: pw.Text(data['cargo_name'].toString(),
                          style: pw.TextStyle(
                              fontSize: 20, font: ttf, color: PdfColors.black)),
                    ),
                    pw.Expanded(flex: 1, child: pw.SizedBox(width: 2)),
              ...
              pw.Padding(
                ...
                child: pw.Row(
                  ...
                  children: [
                    ...
                    pw.Expanded(
                      flex: 5,
                      child: pw.Text('Toll Name:',
                          style: pw.TextStyle(
                              fontSize: 20, font: ttf, color: PdfColors.black)),
                    ),
                    pw.Expanded(
                      flex: 5,
                      child: pw.Text(data['toll_name'].toString(),
                          style: pw.TextStyle(
                              fontSize: 20, font: ttf, color: PdfColors.black)),
                    ),
                    pw.Expanded(flex: 1, child: pw.SizedBox(width: 2)),
              ...
              pw.Padding(
                ...
                child: pw.Row(
                  ...
                  children: [
                    ...
                    pw.Expanded(
                      flex: 5,
                      child: pw.Text('Road Toll Fees:',
                          style: pw.TextStyle(
                              fontSize: 20, font: ttf, color: PdfColors.black)),
                    ),
                    pw.Expanded(
                      flex: 5,
                      child: pw.Text(data['Amount'].toString() + ' FBU',
                          style: pw.TextStyle(
                              fontSize: 20, font: ttf, color: PdfColors.black)),
                    ),
                    pw.Expanded(flex: 1, child: pw.SizedBox(width: 2)),
              ...
              pw.Padding(
                ...
                child: pw.Row(
                  ...
                  children: [
                    ...
                    pw.Expanded(
                      flex: 5,
                      child: pw.Text('Car Reg No:',
                          style: pw.TextStyle(
                              fontSize: 20, font: ttf, color: PdfColors.black)),
                    ),
                    pw.Expanded(
                      flex: 5,
                      child: pw.Text(data['Licence_plate_number'].toString(),
                          style: pw.TextStyle(
                              fontSize: 20, font: ttf, color: PdfColors.black)),
                    ),
                    pw.Expanded(flex: 1, child: pw.SizedBox(width: 2)),
              ...
              pw.Padding(
                ...
                child: pw.Row(
                  ...
                  children: [
                    ...
                    pw.Expanded(
                      flex: 5,
                      child: pw.Text(data['received_by_name'].toString(),
                          style: pw.TextStyle(
                              fontSize: 20, font: ttf, color: PdfColors.black)),
                    ),
                    pw.Expanded(flex: 1, child: pw.SizedBox(width: 2)),
